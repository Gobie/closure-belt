...
@override
###
goog.a11y.aria.Announcer::disposeInternal = ->
  goog.object.forEach @liveRegions_, @domHelper_.removeNode, @domHelper_
  @liveRegions_ = null
  @domHelper_ = null
...
###
goog.a11y.aria.Announcer::say = (message, opt_priority) ->
  goog.dom.setTextContent @getLiveRegion_(opt_priority or goog.a11y.aria.LivePriority.POLITE), message
  return
...
@private
###
goog.a11y.aria.Announcer::getLiveRegion_ = (priority) ->
  liveRegion = @liveRegions_[priority]
  if liveRegion
    
    # Make sure the live region is not aria-hidden.
    goog.a11y.aria.removeState liveRegion, goog.a11y.aria.State.HIDDEN
    return liveRegion
  liveRegion = @domHelper_.createElement("div")
  ...
  @domHelper_.getDocument().body.appendChild liveRegion
  @liveRegions_[priority] = liveRegion
  liveRegion
